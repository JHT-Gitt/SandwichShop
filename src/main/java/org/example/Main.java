...
public class Main {
    public static void main(String[] args) {
        ...
        Sandwich firstInfo = new Sandwich();

        firstInfo.sandwichInfo1();
        System.out.printf("\nWould you like your sandwich loaded [Y/N] ?: ");
        firstInfo.isLoaded = scanner.next();
        if(firstInfo.isLoaded.equals("y") || firstInfo.isLoaded.equals("Y")){
            firstInfo.sandwichInfo2();
            firstInfo.loadedSize();

        }else if(firstInfo.isLoaded.equals("N") || firstInfo.isLoaded.equals("n")) {
            firstInfo.regularPrice();
        }else{
